...
namespace SchoolRegister.Migrations
{
    ...
    [Migration("20220703181659_MoveNameSurnameToAppUser")]
    partial class MoveNameSurnameToAppUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolRegister.Models.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SchoolRegister.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolRegister.Models.Grade", b =>
                {
                    b.HasOne("SchoolRegister.Models.StudentSubject", "StudentSubject")
                        .WithMany("Grades")
            ...
            modelBuilder.Entity("SchoolRegister.Models.Message", b =>
                {
                    b.HasOne("SchoolRegister.Models.AppUser", "ReceiverUser")
                        .WithMany()
                        .HasForeignKey("ReceiverUserId");

                    b.HasOne("SchoolRegister.Models.AppUser", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolRegister.Models.Student", b =>
                {
                    ...
                    b.HasOne("SchoolRegister.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
